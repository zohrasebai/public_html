@php
    ...
    // Section Core Values (Variables adaptées à vos contrôleurs)
    $coreSettings = \App\Models\CoreValue::first();
    $coreItems = \App\Models\CoreValueItem::all();
@endphp

{{-- ================= SECTION 1 : QUI SOMMES-NOUS (CODE ORIGINAL) ================= --}}
...
{{-- ================= SECTION 2 : NOS VALEURS (CODE ORIGINAL) ================= --}}
        ...
        <div class="row">
            ...
            <div class="col-xl-5 col-lg-12">
                <div class="core-images mt-30">
                    <img src="{{ ($coreSettings && $coreSettings->image) ? asset($coreSettings->image) : 'https://cdn.bcs-express.ru/article-head/7180.jpg' }}" alt="QualiPro Values">
                </div>
            </div>
        </div>
    </div>
...
{{-- ================= SECTION 3 : NOTRE ÉQUIPE (DESIGN CENTRÉ) ================= --}}
